...
async function PostingJobsForFetch(e) {
  ...
  const Job_Title = document.querySelector(".postPosition").value;
  ...
  const Office_Location = document.querySelector(".postLocation").value;
  const Email = document.querySelector(".postEmail").value;
